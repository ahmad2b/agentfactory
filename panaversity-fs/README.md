...
**Status**: Phase 2 - MCP Server Implementation (In Progress)
...
**Summaries** (4 tools): add/update/get/list_summaries ó
**Bulk** (1 tool): get_book_archive ó
**Registry** (1 tool): list_books ó
**Search** (2 tools): glob/grep_search ó

**Progress**: 3/14 tools implemented (21%)
...
- =§ Phase 2: MCP tools (3/14 complete)
