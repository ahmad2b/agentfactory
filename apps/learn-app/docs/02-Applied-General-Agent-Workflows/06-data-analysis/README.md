...
**Primary**: Code (data analysis requires precise, reproducible operations)
**Secondary**: Cowork (for interpreting results and planning analyses)
...
| Lesson | Title | Focus |
|--------|-------|-------|
| [L01](./01-general-agent-finance.md) | General Agent for Finance | Why AI-native finance analysis changes the game |
| [L02](./02-finance-workspace-setup.md) | Finance Workspace Setup | Configuring your analysis environment |
| [L03](./03-finance-skills.md) | Finance Skills | Building domain-specific agent skills for financial work |
| [L04](./04-sheets-mcp-integration.md) | Sheets MCP Integration | Connecting to spreadsheet data sources |
| [L05](./05-intent-driven-modeling.md) | Intent-Driven Modeling | Expressing what you want to know, not how to calculate it |
| [L06](./06-ai-native-accounting.md) | AI-Native Accounting | Reconciliation, categorization, and reporting |
| [L07](./07-accounting-platform-mcp.md) | Accounting Platform MCP | Connecting to professional accounting systems |
| [L08](./08-finance-subagents.md) | Finance Subagents | Specialized agents for different financial tasks |
| [L09](./09-governance-compliance.md) | Governance & Compliance | Audit trails, validation, and regulatory awareness |
