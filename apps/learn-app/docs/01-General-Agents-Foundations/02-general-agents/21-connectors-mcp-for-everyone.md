...
prerequisites:
  - "Completion of Lesson 10: MCP Integration (for context)"
  - "Completion of Lesson 20: Browser Integration"
  - "Claude Cowork installed and configured"
---

# Connectors: MCP for Everyone

You learned about MCP (Model Context Protocol) in Lesson 10—how developers create servers that expose tools to Claude Code. Connectors bring the same capability to Cowork, but without requiring any development work.
...
**MCP (Lesson 10)** is for developers building custom integrations:
