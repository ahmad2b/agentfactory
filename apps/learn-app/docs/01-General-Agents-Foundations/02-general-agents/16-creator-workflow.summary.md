...
### Connections
- **Synthesizes**: All Chapter 2 lessons—Origin Story (agency), CLAUDE.md (context), Skills (expertise), MCP (tools), Subagents (delegation), Hooks (automation), Settings (configuration)
